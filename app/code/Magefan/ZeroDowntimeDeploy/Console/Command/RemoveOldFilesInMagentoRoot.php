...
class RemoveOldFilesInMagentoRoot extends Command
{
    /**
     * @var Config
     */
    ...
    {
        $this->setName('magefan:zero-downtime:remove-old-files-in-magento-root');
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        if ($this->config->isEnabled()) {
            ...
            $this->deploy->removeOldFilesInMagentoRoot(true, true, true);
        } else {
