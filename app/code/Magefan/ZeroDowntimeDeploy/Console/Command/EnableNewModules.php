...
class EnableNewModules extends Command
{
    /**
     * @var Config
     */
    ...
    {
        $this->setName('magefan:zero-downtime:enable-new-modules');
        $this->setDescription('Create Instance');
